...
tabfile <-  path(oscdir, "plumbkitch_states.png")
...
tabfile <-  path(oscdir, "plumbkitch_regions.png")
gtsave(tab, tabfile, zoom=2, expand=20)
# {{< include ../../_gt_snippet.qmd >}}
...
tabfile <-  path(oscdir, "plumbkitch_region_breakdown.png")
gtsave(tab, tabfile, zoom=2, expand=20)
# {{< include ../../_gt_snippet.qmd >}}
...
tabfile <-  path(oscdir, "plumbkitch_counties.png")
gtsave(tab, tabfile, zoom=2, expand=20)
# {{< include ../../_gt_snippet.qmd >}}
```
...
tabfile <-  path(oscdir, "plumbkitch_cities.png")
gtsave(tab, tabfile, zoom=2, expand=20)
# {{< include ../../_gt_snippet.qmd >}}
```
