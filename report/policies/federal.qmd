...
p <- budauth |> 
  ...
  scale_y_continuous(name="Authorization ($ billions)",
                     breaks=seq(0, 2e8, 5e7),
                     labels = dollar_format(scale=1e-6),
                     limits=c(0, NA)) +
  scale_x_continuous(name="Federal fiscal year") +
  ggtitle("Federal budget authorization for housing assistance") +
  labs(caption="Source: Federal Budget Database, FFY 2023") +
  theme_bw() +
  caption_left
