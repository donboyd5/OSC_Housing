...
plot_save("fedbudget_housing_assistance", pdata, p)
...
tabfile <- tab_save("hud_nyawards", tabdata, tab)
...
# tabfile <-  path(oscdir, "lihtc_units_table.png")
# gtsave(tab, tabfile, zoom=2, expand=20)

tabfile <- tab_save("lihtc_units_table", tabdata, tab)
...
plot_save("lihtc_counties", lihtc_cnty3, county_map)
...
# tabfile <-  path(oscdir, "picture_ny.png")
# gtsave(tab, tabfile, zoom=2, expand=20)

tabfile <- tab_save("picture_ny", tabdata, tab)
...
# tabfile <-  path(oscdir, "picture_ny_race.png")
# gtsave(tab, tabfile, zoom=2, expand=20)

tabfile <- tab_save("picture_ny_race", tabdata, tab)
# {{< include ../_gt_snippet.qmd >}}
...
# tabfile <-  path(oscdir, "picture_states.png")
# gtsave(tab, tabfile, zoom=2, expand=20)

tabfile <- tab_save("picture_states", tabdata, tab)
...
# tabfile <-  path(oscdir, "picture_nycounties.png")
# gtsave(tab, tabfile, zoom=2, expand=20)

tabfile <- tab_save("picture_nycounties", tabdata, tab)
# {{< include ../_gt_snippet.qmd >}}
